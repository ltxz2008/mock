...
import com.crt.test.protocol.DubboMockServer;
import com.crt.test.protocol.MethodRule;
import com.crt.test.protocol.MockGenericService;
import com.crt.test.protocol.MockTestServiceImpl;
...
@Controller
public class MockOperDefineController extends BaseController {

    @Resource
    MockOperDefineService mockOperDefineServiceImpl;

    @Resource
    MockServiceService mockServiceServiceImpl;

    @Resource
    DubboMockServer dubboMockServer;

    @Resource
    MockTestServiceImpl mockTestServiceImpl;
