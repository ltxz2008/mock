package com.crt.test.controller;
...
import com.crt.test.mock.auto.mapper.MockTestParamMapper;
import com.crt.test.mock.auto.mapper.MockTestSubjectMapper;
...
import com.crt.test.mock.po.MockTestSubject;
import com.crt.test.mock.po.MockTestSubjectExample;
import com.crt.test.page.Page;
import com.google.common.collect.Lists;
import com.google.common.collect.Maps;

@Controller
public class MockTestSubjectParamController extends BaseController {

    @Resource
    MockTestParamMapper mockTestParamMapper;

    @Resource
    MockTestSubjectMapper mockTestSubjectMapper;
	...
	try {
		...
		for (int i = 0; i < mockKeys.size(); i++) {
		    ...
		    // throw new RuntimeException("命名不能包含以下关键字:" +
		    // ArrayUtils.toString(intelChars));
		    // }
