...
public class TemplateImpl implements Template {   
	...
	try {
	    ...
	    throw new IllegalArgumentException("Failed to resolve template - " + id + " - " + e.getMessage(), e);
	}
    }
     ...
     * @return
     */
    public static TemplateImpl create(String id, String template, TemplateImpl existing) {
